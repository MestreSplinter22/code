  ...
  <nav className="border-b border-zinc-800 bg-black/95 backdrop-blur-sm sticky top-0 z-50">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between h-16">
        ...
        {/* Logo */}
        <a href="/" className="flex-shrink-0 font-bold text-xl tracking-tighter hover:opacity-80 transition">
        ...
        <div className="flex items-center gap-6">
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-4">
                  ...
                  <a href="/auth/logout" className="text-sm font-medium text-red-500 hover:text-red-400 transition border border-red-900/50 px-3 py-1 rounded-full hover:bg-red-900/20">
                      Sair
                  </a>
              </div>
            ) : (
              <a href="/auth/login" className="bg-yellow-500 text-black px-5 py-2 rounded-full text-sm font-bold hover:bg-yellow-400 hover:shadow-[0_0_15px_rgba(234,179,8,0.4)] transition-all">
                  Entrar
              </a>
            )}
        </div>
